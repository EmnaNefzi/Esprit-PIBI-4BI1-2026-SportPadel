...
package pi_padel_sa.sa_master_load_0_1;
 ...
 * @status
 */
public class SA_MASTER_LOAD implements TalendJob {
	...
	private final String jobName = "SA_MASTER_LOAD";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SA_MASTER_LOAD.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_MASTER_LOAD.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_padel_rackets_sa_0_1.SA_Load_Padel_Rackets_SA childJob_tRunJob_1 = new pi_padel_sa.sa_load_padel_rackets_sa_0_1.SA_Load_Padel_Rackets_SA();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_players_women_0_1.SA_Load_Players_Women childJob_tRunJob_2 = new pi_padel_sa.sa_load_players_women_0_1.SA_Load_Players_Women();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_players_men_0_1.SA_Load_Players_Men childJob_tRunJob_3 = new pi_padel_sa.sa_load_players_men_0_1.SA_Load_Players_Men();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_padeltour_2026_0_1.SA_Load_PadelTour_2026 childJob_tRunJob_6 = new pi_padel_sa.sa_load_padeltour_2026_0_1.SA_Load_PadelTour_2026();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_calender2024_0_1.SA_Load_Calender2024 childJob_tRunJob_5 = new pi_padel_sa.sa_load_calender2024_0_1.SA_Load_Calender2024();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_calender2023_0_1.SA_Load_Calender2023 childJob_tRunJob_4 = new pi_padel_sa.sa_load_calender2023_0_1.SA_Load_Calender2023();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_tournois_apr_a_sep_0_1.SA_Load_Tournois_apr_a_sep childJob_tRunJob_7 = new pi_padel_sa.sa_load_tournois_apr_a_sep_0_1.SA_Load_Tournois_apr_a_sep();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pi_padel_sa.sa_load_data_externe_0_1.SA_Load_data_externe childJob_tRunJob_8 = new pi_padel_sa.sa_load_data_externe_0_1.SA_Load_data_externe();
				// pass DataSources
	...
	public static void main(String[] args) {
		final SA_MASTER_LOAD SA_MASTER_LOADClass = new SA_MASTER_LOAD();

		int exitCode = SA_MASTER_LOADClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_MASTER_LOAD.class.getClassLoader()
					.getResourceAsStream("pi_padel_sa/sa_master_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_MASTER_LOAD.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_MASTER_LOAD");
		}
...
/************************************************************************************************
 * 78575 characters generated by Talend Open Studio for Data Integration on the
 * 2 mars 2026, 22:33:41 WAT
 ************************************************************************************************/